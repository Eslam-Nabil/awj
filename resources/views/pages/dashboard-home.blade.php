...
<div class="card-body">
    <form action="{{ route('home.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="custom-file mb-3">
            <input type="file" class="custom-file-input" value="{{ $homedata->first_side_image ?? '' }}" name="first_side_image" id="customFile">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control"  name="third_left_description" id="exampleFormControlTextarea1" rows="3">
                {{ $homedata->third_left_description ?? '' }}
            </textarea>
        </div>
        <div class="form-group">
            <label for="exampleFormControlTextarea1">Right Description</label>
            <textarea class="form-control"  name="third_right_description" id="exampleFormControlTextarea1" rows="3">
                {{ $homedata->third_right_description ?? '' }}
            </textarea>
        </div>
        <div class="custom-file mb-3">
            <input type="file" class="custom-file-input" value="{{ $homedata->third_side_image  ?? '' }}" name="third_side_image" id="customFile">
            <label class="custom-file-label"  for="customFile">Side Image</label>
        </div>
